...
public class ConcoctiSolidifierScreen extends AbstractContainerScreen<ConcoctiSolidifierMenu> {
    ...
    private final FluidBar<ConcoctiSolidifierMenu> fluid = new FluidBar<>(this, menu, ResourceLocation.withDefaultNamespace("empty"), 42, 28);
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        fluid.render(guiGraphics, mouseX, mouseY, menu.getNumberFluidLeft(), menu.getMaxFluidLeft(), font);
    }
}
